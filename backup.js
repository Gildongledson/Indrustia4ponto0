...
function init() {
    ...
    var sphereeMaterial = new THREE.MeshPhongMaterial({ color: 0x0000ff });
    ...
    var CaixaColetaMaterial = new THREE.MeshPhongMaterial({ color: 0xff0000 });
    ...
    var CaixaColetaaMaterial = new THREE.MeshPhongMaterial({ color: 0x00ff00});
